...
void display(Shader shader, Model modelo, Model llantas)
{
	shader.use();
	...
	model = glm::translate(tmp, glm::vec3(4.6f, -0.5f, 2.2f));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	shader.setMat4("model", model);
	llantas.Draw(shader);	//Izq delantera

	model = glm::translate(tmp, glm::vec3(-1.5f, -0.5f, 2.2f));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	shader.setMat4("model", model);
	llantas.Draw(shader);	//Der delantera

	model = glm::translate(tmp, glm::vec3(-1.5f, -0.5f, -6.3f));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	shader.setMat4("model", model);
	llantas.Draw(shader);	//Der trasera

	model = glm::translate(tmp, glm::vec3(4.6f, -0.5f, -6.3f));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	shader.setMat4("model", model);
...
int main()
{
	...
	// Load models
	Model ourModel =((char *)"Models/kitt.obj");
	Model llantasModel = ((char *)"Models/llanta/llanta.obj");
